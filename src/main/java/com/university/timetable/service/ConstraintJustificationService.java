...
/**
 * Service that uses OptaPlanner's SolutionManager to explain constraint violations.
...
public class ConstraintJustificationService {
    ...
    public ScoreAnalysisDTO analyzeSolution(TimeTable solution) {
        ...
        Map<String, ConstraintMatchTotal<HardSoftScore>> constraintMatchTotals = 
            explanation.getConstraintMatchTotalMap();
        ...
        analysis.getHardViolations().sort((a, b) -> 
            Integer.compare(b.getMatchCount(), a.getMatchCount()));
        analysis.getSoftViolations().sort((a, b) -> 
            Integer.compare(b.getMatchCount(), a.getMatchCount()));
