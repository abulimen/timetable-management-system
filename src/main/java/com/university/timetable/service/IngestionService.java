...
public class IngestionService {
    ...
    private void processRoomsSheet(Sheet sheet, ImportResultDTO result) {
        ...
        for (Row row : sheet) {
            ...
            Zone zone = zoneName != null ? 
                zoneRepository.findByName(validationService.sanitizeString(zoneName)).orElse(null) : null;
    ...
    private void processStudentGroupsSheet(Sheet sheet, ImportResultDTO result) {
        ...
        for (Row row : sheet) {
            ...
            if (name == null || parentName == null || parentName.isEmpty()) continue;
    ...
    private void processCoursesSheet(Sheet sheet, ImportResultDTO result) {
        ...
        for (Row row : sheet) {
            ...
            Course course = new Course(code, validationService.sanitizeString(name), weeklyHours != null ? weeklyHours : 0);
